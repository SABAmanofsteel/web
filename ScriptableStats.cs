...
namespace TarodevController
{
    ...
    public class ScriptableStats : ScriptableObject
    {
        ...
        [Tooltip("The speed multiplier during a dash")]
        public float DashSpeed = 20f;

        [Tooltip("The cooldown time after a dash before you can dash again")]
        public float DashCooldown = 1f; // New field for dash cooldown
    }
}
